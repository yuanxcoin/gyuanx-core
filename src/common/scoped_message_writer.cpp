...
#define GYUANX_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/gyuanx_integration_test_hooks.h"

// NOTE(gyuanx): This file only exists because I need a way to hook into the
...
// gyuanx_integration_test_hooks.h functions which isn't possible to expose in
