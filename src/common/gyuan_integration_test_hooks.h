...
#ifndef GYUANX_INTEGRATION_TEST_HOOKS_H
#define GYUANX_INTEGRATION_TEST_HOOKS_H
...
#endif // GYUANX_INTEGRATION_TEST_HOOKS_H
...
//
// -------------------------------------------------------------------------------------------------
#ifdef GYUANX_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include <string.h>
#include <assert.h>
#include <sys/stat.h>
#include <fcntl.h>
...
#endif // GYUANX_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
