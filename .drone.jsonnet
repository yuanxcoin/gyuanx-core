    ...
    steps: [submodules,
        {
            ...
            commands: [
                ...
                'eatmydata ' + apt_get_quiet + ' install --no-install-recommends -y git-buildpackage devscripts equivs g++ ccache openssh-client gpg curl ca-certificates',
                ...
                'curl -s https://deb.loki.network/public.gpg | apt-key add -',
